...
public class MethodEntry extends SymbolTableEntry 
{
    ...
    public MethodEntry(String methodName, String type, SymbolTableEntry parent_tableEntry, boolean is_mainMethod)
    {
        ...
        localVariables = new HashMap<>(); //collections of (variableName -> type)
    }
